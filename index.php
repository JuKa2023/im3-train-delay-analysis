    ...
    <main class="container my-32 mx-auto px-4 py-8">
        <!-- Page Title -->
        <h1 class="text-4xl font-bold mb-8">Zugverspätungen und Wetterstörungen: Eine Datengeschichte</h1>
        ...
        <!-- April Bar Chart -->
                ...
                <p class="mt-4 text-sm">Die höchste Anzahl von Verspätungen (95) trat am 8. April auf, was mit dem Tag der meisten Wetterstörungen (18) zusammenfiel. Es gab mehrere Tage mit überdurchschnittlichen Verspätungen (mehr als 81), was darauf hindeutet, dass die hohe monatliche Gesamtzahl nicht auf ein einzelnes extremes Ereignis zurückzuführen war. Wetterstörungen variierten von Tag zu Tag erheblich, von 4 bis 18 Vorfällen. Die Daten zeigen eine klare Korrelation zwischen Tagen mit hohen Wetterstörungen und erhöhten Zugverspätungen.</p>
